...
(require __DIR__.'/App_KernelDevDebugContainer.php')->set(\ContainerIG96eLS\App_KernelDevDebugContainer::class, null);
require __DIR__.'/ContainerIG96eLS/getWebProfiler_Controller_RouterService.php';
require __DIR__.'/ContainerIG96eLS/getWebProfiler_Controller_ProfilerService.php';
require __DIR__.'/ContainerIG96eLS/getWebProfiler_Controller_ExceptionPanelService.php';
require __DIR__.'/ContainerIG96eLS/getValidator_WhenService.php';
require __DIR__.'/ContainerIG96eLS/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerIG96eLS/getValidator_NoSuspiciousCharactersService.php';
require __DIR__.'/ContainerIG96eLS/getValidator_ExpressionLanguageService.php';
require __DIR__.'/ContainerIG96eLS/getValidator_ExpressionService.php';
require __DIR__.'/ContainerIG96eLS/getValidator_EmailService.php';
require __DIR__.'/ContainerIG96eLS/getTwig_ValidatorService.php';
require __DIR__.'/ContainerIG96eLS/getTwig_Runtime_SerializerService.php';
require __DIR__.'/ContainerIG96eLS/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerIG96eLS/getTwig_Runtime_ImportmapService.php';
require __DIR__.'/ContainerIG96eLS/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerIG96eLS/getTwig_Mailer_MessageListenerService.php';
require __DIR__.'/ContainerIG96eLS/getTwig_Form_RendererService.php';
require __DIR__.'/ContainerIG96eLS/getTwig_Form_EngineService.php';
require __DIR__.'/ContainerIG96eLS/getTwig_ErrorRenderer_HtmlService.php';
require __DIR__.'/ContainerIG96eLS/getTurbo_Twig_RuntimeService.php';
require __DIR__.'/ContainerIG96eLS/getTurbo_Doctrine_EventListenerService.php';
require __DIR__.'/ContainerIG96eLS/getTranslation_Loader_YmlService.php';
require __DIR__.'/ContainerIG96eLS/getTranslation_Loader_XliffService.php';
require __DIR__.'/ContainerIG96eLS/getTranslation_Loader_ResService.php';
require __DIR__.'/ContainerIG96eLS/getTranslation_Loader_QtService.php';
require __DIR__.'/ContainerIG96eLS/getTranslation_Loader_PoService.php';
require __DIR__.'/ContainerIG96eLS/getTranslation_Loader_PhpService.php';
require __DIR__.'/ContainerIG96eLS/getTranslation_Loader_MoService.php';
require __DIR__.'/ContainerIG96eLS/getTranslation_Loader_JsonService.php';
require __DIR__.'/ContainerIG96eLS/getTranslation_Loader_IniService.php';
require __DIR__.'/ContainerIG96eLS/getTranslation_Loader_DatService.php';
require __DIR__.'/ContainerIG96eLS/getTranslation_Loader_CsvService.php';
require __DIR__.'/ContainerIG96eLS/getTexter_TransportsService.php';
require __DIR__.'/ContainerIG96eLS/getStimulus_UxControllersTwigRuntimeService.php';
require __DIR__.'/ContainerIG96eLS/getStimulus_AssetMapper_LoaderJavascriptCompilerService.php';
require __DIR__.'/ContainerIG96eLS/getStimulus_AssetMapper_ControllersMapGeneratorService.php';
require __DIR__.'/ContainerIG96eLS/getSession_Handler_NativeService.php';
require __DIR__.'/ContainerIG96eLS/getSession_FactoryService.php';
require __DIR__.'/ContainerIG96eLS/getServicesResetterService.php';
require __DIR__.'/ContainerIG96eLS/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerIG96eLS/getSecurity_RouteLoader_LogoutService.php';
require __DIR__.'/ContainerIG96eLS/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/ContainerIG96eLS/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerIG96eLS/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/ContainerIG96eLS/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/ContainerIG96eLS/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/ContainerIG96eLS/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/ContainerIG96eLS/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/ContainerIG96eLS/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/ContainerIG96eLS/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/ContainerIG96eLS/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerIG96eLS/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerIG96eLS/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerIG96eLS/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerIG96eLS/getSecrets_VaultService.php';
require __DIR__.'/ContainerIG96eLS/getSecrets_EnvVarLoaderService.php';
require __DIR__.'/ContainerIG96eLS/getRouting_LoaderService.php';
require __DIR__.'/ContainerIG96eLS/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerIG96eLS/getPropertyInfo_ConstructorExtractorService.php';
require __DIR__.'/ContainerIG96eLS/getNotifier_TransportFactory_NullService.php';
require __DIR__.'/ContainerIG96eLS/getMonolog_Logger_MessengerService.php';
require __DIR__.'/ContainerIG96eLS/getMonolog_Logger_MailerService.php';
require __DIR__.'/ContainerIG96eLS/getMonolog_Logger_DeprecationService.php';
require __DIR__.'/ContainerIG96eLS/getMonolog_Logger_AssetMapperService.php';
require __DIR__.'/ContainerIG96eLS/getMonolog_LoggerService.php';
require __DIR__.'/ContainerIG96eLS/getMessenger_TransportFactoryService.php';
require __DIR__.'/ContainerIG96eLS/getMessenger_Transport_Sync_FactoryService.php';
require __DIR__.'/ContainerIG96eLS/getMessenger_Transport_InMemory_FactoryService.php';
require __DIR__.'/ContainerIG96eLS/getMessenger_Transport_FailedService.php';
require __DIR__.'/ContainerIG96eLS/getMessenger_Transport_Doctrine_FactoryService.php';
require __DIR__.'/ContainerIG96eLS/getMessenger_Transport_AsyncService.php';
require __DIR__.'/ContainerIG96eLS/getMessenger_RoutableMessageBusService.php';
require __DIR__.'/ContainerIG96eLS/getMessenger_Retry_SendFailedMessageForRetryListenerService.php';
require __DIR__.'/ContainerIG96eLS/getMessenger_Retry_MultiplierRetryStrategy_FailedService.php';
require __DIR__.'/ContainerIG96eLS/getMessenger_Retry_MultiplierRetryStrategy_AsyncService.php';
require __DIR__.'/ContainerIG96eLS/getMessenger_Listener_StopWorkerOnRestartSignalListenerService.php';
require __DIR__.'/ContainerIG96eLS/getMessenger_Failure_SendFailedMessageToFailureTransportListenerService.php';
require __DIR__.'/ContainerIG96eLS/getMessenger_Bus_Default_Middleware_TraceableService.php';
require __DIR__.'/ContainerIG96eLS/getMessenger_Bus_Default_Middleware_SendMessageService.php';
require __DIR__.'/ContainerIG96eLS/getMessenger_Bus_Default_Middleware_HandleMessageService.php';
require __DIR__.'/ContainerIG96eLS/getMailer_TransportsService.php';
require __DIR__.'/ContainerIG96eLS/getMailer_TransportFactory_SmtpService.php';
require __DIR__.'/ContainerIG96eLS/getMailer_TransportFactory_SendmailService.php';
require __DIR__.'/ContainerIG96eLS/getMailer_TransportFactory_NullService.php';
require __DIR__.'/ContainerIG96eLS/getMailer_TransportFactory_NativeService.php';
require __DIR__.'/ContainerIG96eLS/getHttpClient_UriTemplateService.php';
require __DIR__.'/ContainerIG96eLS/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerIG96eLS/getForm_TypeGuesser_ValidatorService.php';
require __DIR__.'/ContainerIG96eLS/getForm_TypeGuesser_DoctrineService.php';
require __DIR__.'/ContainerIG96eLS/getForm_TypeExtension_Upload_ValidatorService.php';
require __DIR__.'/ContainerIG96eLS/getForm_TypeExtension_Password_PasswordHasherService.php';
require __DIR__.'/ContainerIG96eLS/getForm_TypeExtension_Form_ValidatorService.php';
require __DIR__.'/ContainerIG96eLS/getForm_TypeExtension_Form_TransformationFailureHandlingService.php';
require __DIR__.'/ContainerIG96eLS/getForm_TypeExtension_Form_PasswordHasherService.php';
require __DIR__.'/ContainerIG96eLS/getForm_TypeExtension_Form_HttpFoundationService.php';
require __DIR__.'/ContainerIG96eLS/getForm_TypeExtension_Form_Flow_SessionDataStorageService.php';
require __DIR__.'/ContainerIG96eLS/getForm_TypeExtension_Form_DataCollectorService.php';
require __DIR__.'/ContainerIG96eLS/getForm_TypeExtension_CsrfService.php';
require __DIR__.'/ContainerIG96eLS/getForm_Type_FormService.php';
require __DIR__.'/ContainerIG96eLS/getForm_Type_FileService.php';
require __DIR__.'/ContainerIG96eLS/getForm_Type_EntityService.php';
require __DIR__.'/ContainerIG96eLS/getForm_Type_ColorService.php';
require __DIR__.'/ContainerIG96eLS/getForm_Type_ChoiceService.php';
require __DIR__.'/ContainerIG96eLS/getForm_ServerParamsService.php';
require __DIR__.'/ContainerIG96eLS/getForm_RegistryService.php';
require __DIR__.'/ContainerIG96eLS/getForm_Listener_PasswordHasherService.php';
require __DIR__.'/ContainerIG96eLS/getForm_FactoryService.php';
require __DIR__.'/ContainerIG96eLS/getForm_ChoiceListFactory_CachedService.php';
require __DIR__.'/ContainerIG96eLS/getErrorHandler_ErrorRenderer_HtmlService.php';
require __DIR__.'/ContainerIG96eLS/getErrorControllerService.php';
require __DIR__.'/ContainerIG96eLS/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/ContainerIG96eLS/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/ContainerIG96eLS/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerIG96eLS/getDoctrine_Orm_Messenger_EventSubscriber_DoctrineClearEntityManagerService.php';
require __DIR__.'/ContainerIG96eLS/getDoctrine_Orm_Messenger_DoctrineSchemaListenerService.php';
require __DIR__.'/ContainerIG96eLS/getDoctrine_Orm_Listeners_PdoSessionHandlerSchemaListenerService.php';
require __DIR__.'/ContainerIG96eLS/getDoctrine_Orm_Listeners_LockStoreSchemaListenerService.php';
require __DIR__.'/ContainerIG96eLS/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaListenerService.php';
require __DIR__.'/ContainerIG96eLS/getDoctrine_Orm_Listeners_DoctrineDbalCacheAdapterSchemaListenerService.php';
require __DIR__.'/ContainerIG96eLS/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerIG96eLS/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerIG96eLS/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerIG96eLS/getDebug_Security_Firewall_Authenticator_MainService.php';
require __DIR__.'/ContainerIG96eLS/getDebug_FileLinkFormatter_UrlFormatService.php';
require __DIR__.'/ContainerIG96eLS/getDebug_ErrorHandlerConfiguratorService.php';
require __DIR__.'/ContainerIG96eLS/getDataCollector_Request_SessionCollectorService.php';
require __DIR__.'/ContainerIG96eLS/getController_TemplateAttributeListenerService.php';
require __DIR__.'/ContainerIG96eLS/getContainer_GetenvService.php';
require __DIR__.'/ContainerIG96eLS/getContainer_GetRoutingConditionServiceService.php';
require __DIR__.'/ContainerIG96eLS/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerIG96eLS/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerIG96eLS/getCache_SystemClearerService.php';
require __DIR__.'/ContainerIG96eLS/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerIG96eLS/getCache_AppClearerService.php';
require __DIR__.'/ContainerIG96eLS/getAssetMapper_Importmap_GeneratorService.php';
require __DIR__.'/ContainerIG96eLS/getAssetMapper_Importmap_ConfigReaderService.php';
require __DIR__.'/ContainerIG96eLS/getAssetMapper_Compiler_JavascriptImportPathCompilerService.php';
require __DIR__.'/ContainerIG96eLS/getAssetMapper_Compiler_CssAssetUrlCompilerService.php';
require __DIR__.'/ContainerIG96eLS/getTemplateControllerService.php';
require __DIR__.'/ContainerIG96eLS/getRedirectControllerService.php';
require __DIR__.'/ContainerIG96eLS/getProfilerControllerService.php';
require __DIR__.'/ContainerIG96eLS/getPokemonServiceService.php';
require __DIR__.'/ContainerIG96eLS/getMenuServiceService.php';
require __DIR__.'/ContainerIG96eLS/getLanguageManagerService.php';
require __DIR__.'/ContainerIG96eLS/getVaultControllerService.php';
require __DIR__.'/ContainerIG96eLS/getStatsControllerService.php';
require __DIR__.'/ContainerIG96eLS/getSearchControllerService.php';
require __DIR__.'/ContainerIG96eLS/getScanControllerService.php';
require __DIR__.'/ContainerIG96eLS/getRootControllerService.php';
require __DIR__.'/ContainerIG96eLS/getLanguageControllerService.php';
require __DIR__.'/ContainerIG96eLS/getDashboardControllerService.php';
require __DIR__.'/ContainerIG96eLS/get_Signing_Messenger_DefaultSerializerService.php';
require __DIR__.'/ContainerIG96eLS/get_ServiceLocator_TJNRSaVService.php';
require __DIR__.'/ContainerIG96eLS/get_ServiceLocator_Oqd5g0tService.php';
require __DIR__.'/ContainerIG96eLS/get_ServiceLocator_8JS6QTAService.php';
require __DIR__.'/ContainerIG96eLS/get_ServiceLocator_1vYpZ1B_KernelregisterContainerConfigurationService.php';
require __DIR__.'/ContainerIG96eLS/get_ServiceLocator_1vYpZ1B_KernelloadRoutesService.php';
require __DIR__.'/ContainerIG96eLS/get_ServiceLocator_1vYpZ1BService.php';
require __DIR__.'/ContainerIG96eLS/get_Security_RequestMatcher_QZDP5mDService.php';
require __DIR__.'/ContainerIG96eLS/get_Messenger_SigningSerializer_SigningKeyService.php';
require __DIR__.'/ContainerIG96eLS/get_Messenger_HandlerDescriptor_JyyWvHwService.php';
require __DIR__.'/ContainerIG96eLS/get_Messenger_HandlerDescriptor_GEx8y9aService.php';
require __DIR__.'/ContainerIG96eLS/get_Messenger_HandlerDescriptor_WG_ORBvService.php';
require __DIR__.'/ContainerIG96eLS/get_Messenger_HandlerDescriptor_UKIJHilService.php';
require __DIR__.'/ContainerIG96eLS/get_Messenger_HandlerDescriptor_Qv3faSNService.php';
require __DIR__.'/ContainerIG96eLS/get_Messenger_HandlerDescriptor_NumTeF8Service.php';
require __DIR__.'/ContainerIG96eLS/get_Messenger_HandlerDescriptor_EXsqOW5Service.php';
require __DIR__.'/ContainerIG96eLS/get_Messenger_HandlerDescriptor_Dkv9sRYService.php';
require __DIR__.'/ContainerIG96eLS/get_Messenger_HandlerDescriptor_Die6BxeService.php';
require __DIR__.'/ContainerIG96eLS/get_Debug_ValueResolver_Security_UserValueResolverService.php';
require __DIR__.'/ContainerIG96eLS/get_Debug_ValueResolver_Security_SecurityTokenValueResolverService.php';
require __DIR__.'/ContainerIG96eLS/get_Debug_ValueResolver_Doctrine_Orm_EntityValueResolverService.php';
require __DIR__.'/ContainerIG96eLS/get_Debug_ValueResolver_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerIG96eLS/get_Debug_ValueResolver_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerIG96eLS/get_Debug_ValueResolver_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerIG96eLS/get_Debug_ValueResolver_ArgumentResolver_RequestPayloadService.php';
require __DIR__.'/ContainerIG96eLS/get_Debug_ValueResolver_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerIG96eLS/get_Debug_ValueResolver_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerIG96eLS/get_Debug_ValueResolver_ArgumentResolver_QueryParameterValueResolverService.php';
require __DIR__.'/ContainerIG96eLS/get_Debug_ValueResolver_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerIG96eLS/get_Debug_ValueResolver_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerIG96eLS/get_Debug_ValueResolver_ArgumentResolver_DatetimeService.php';
require __DIR__.'/ContainerIG96eLS/get_Debug_ValueResolver_ArgumentResolver_BackedEnumResolverService.php';
require __DIR__.'/ContainerIG96eLS/get_Debug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/ContainerIG96eLS/get_Debug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerIG96eLS/get_Debug_Security_Voter_Security_Access_ClosureVoterService.php';
require __DIR__.'/ContainerIG96eLS/get_Debug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
...
$classes[] = 'App\Service\LicenseServiceFactory';
$classes[] = 'App\Service\License\PokemonLicenseService';
$classes[] = 'App\Controller\StatsController';
$classes[] = 'App\Controller\VaultController';
$classes[] = 'App\Service\LanguageManager';
$classes[] = 'App\Service\MenuService';
$classes[] = 'App\Service\PokemonService';
